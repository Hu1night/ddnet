...
MACRO_CONFIG_STR(SvModeName, sv_mode_name, 64, "DDRace", CFGFLAG_SERVER, "你想使用的模式名字")
...
MACRO_CONFIG_INT(ClDeclaredDDNetVersion, cl_ddnet_ver_number, 18051, 0, 999999999, CFGFLAG_CLIENT | CFGFLAG_SAVE, "设置你的DDNet版本")
